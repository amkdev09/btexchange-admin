...
import MainHeader from "../../layout/header/mainHeader.jsx";
...
const OTP_LENGTH = 6; // Second game uses 6-digit OTP
    ...
    onSubmit: async (values) => {
      ...
      try {
        if (step === steps.request) {
          ...
          navigate("/network/login", { state: { email } });
        }
      } catch (err) {
